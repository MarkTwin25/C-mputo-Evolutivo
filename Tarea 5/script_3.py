...
def graficas_aptitud(funcion, intervalo):
    ...
    graficar_evolucion_aptitud_2(funcion, intervalo, 10, 100, 0.1, 1000, enfriamiento_exponencial, 1000, 1234)
    graficar_evolucion_aptitud_2(funcion, intervalo, 10, 100, 0.1, 1000, enfriamiento_lineal, 1000, 1234)
    graficar_evolucion_aptitud_genetico(funcion, intervalo, 100, 10, 0.01, 100, generacional, 1234)
    graficar_evolucion_aptitud_genetico(funcion, intervalo, 100, 10, 0.01, 100, generacional_elitismo, 1234)
    graficar_evolucion_aptitud_genetico(funcion, intervalo, 100, 10, 0.01, 100, reemplazo_peores, 1234)
    plt.legend(["Exponencial", "Lineal", "Generacional", "Generacional con elitismo", "Reemplazo de los peores"])
    plt.show()
